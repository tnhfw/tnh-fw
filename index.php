...
/*
The path to the directory 
of your personal libraries, it contains your PHP classes, package, etc.
...
/*
The path to the directory 
of functions or helper systems, it contains PHP functions that perform a particular task: 
character string processing, URL, etc.
*/
...
/*
The path to the directory 
of your PHP personal functions or helper, it contains your PHP functions 
that perform a particular task: utilities, etc.
...
/*
The path to the directory 
of sources external to your application, if you have already used "composer" you know what that means.
*/
define('VENDOR_PATH', ROOT_PATH.'vendor'.DS);

/*
The path to the directory 
of your most often used files that is to say which contains your files of the application, 
...
of your application, if you already know the MVC architecture 
you know what a controller means; it is he who makes the business logic of your application in general.
*/
...
/*
The path to the directory 
of your model classes of your application, 
